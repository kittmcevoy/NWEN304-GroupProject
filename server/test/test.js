...
const app = 'https://nwen304-group-host.herokuapp.com';
chai.use(chai_http);
...
describe('Status codes, not logged in', function () {
    ...
    describe('Deny access', function () {
        it('Add item page', function (done) {
            request(
                'https://nwen304-group-host.herokuapp.com/add-item',
        ...
        it('Cart page', function (done) {
            request('https://nwen304-group-host.herokuapp.com/cart', function (error, res, body) {
                expect(res.body).to.contain(403);
                done();
            });
        });
